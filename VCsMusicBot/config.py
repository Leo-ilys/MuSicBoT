...
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "𝐌𝐔𝐒𝐈𝐂 𝐋𝐄𝐎𝐓𝐇𝐎𝐍 ( حساب الاغاني )")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "zauteschat")
PROJECT_NAME = getenv("PROJECT_NAME", "𝐌𝐔𝐒𝐈𝐂 𝐋𝐄𝐎𝐓𝐇𝐎𝐍")
SOURCE_CODE = getenv("SOURCE_CODE", "github.com/Leo-ilys/MuSicBoT")
